      ...
      >
        {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
          <View style={styles.formContainer}>
            ...
            <Button onPress={handleSubmit} label="Sign In" style={styles.button} backgroundColor='blue' textColor='black' />
          </View>
        )}
      </Formik>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>
          ...
          <Text 
            ...
            onPress={() => navigation.navigate('Signup')} // Navigate to SignIn
          >
            Sign Up
          </Text>
        </Text>
